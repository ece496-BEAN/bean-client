    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <main className="flex-grow p-4 overflow-y-auto">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {/* Spending Summary */}
          <Card className="col-span-full bg-white shadow-lg" onClick={() => router.push("/budget-page")}>
          ...
          {/* Spending Categories */}
          <Card className="bg-white shadow-lg lg:row-span-2" onClick={() => router.push("/budget-page")}>
            <CardHeader className="pb-2">
          ...
          {/* Recent Transactions */}
          <Card className="bg-white shadow-lg md:col-span-2 lg:row-span-2" onClick={() => router.push("/recent-transactions-page")}>
            <CardHeader className="pb-2">
